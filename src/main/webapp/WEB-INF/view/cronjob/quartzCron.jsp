...
<script src="<c:url value='/resources/js/quartzcron/cron.js'/>"
			...
			<div class="easyui-tabs" data-options="fit:true,border:false">
				<div title="秒">
					...
					<div class="line">
						...
						周期从 <input class="numberspinner" style="width: 60px;"
							data-options="min:1,max:58" value="1"> - <input
							class="numberspinner" style="width: 60px;"
					...
					<div class="imp secondList">
						<input type="checkbox" value="1">01 <input type="checkbox"
					...
					<div class="imp secondList">
						<input type="checkbox" value="11">11 <input
							...
							value="13">13 <input type="checkbox" value="14">14
						<input type="checkbox" value="15">15 <input
							type="checkbox" value="16">16 <input type="checkbox"
							value="17">17 <input type="checkbox" value="18">18
					...
					<div class="imp secondList">
						<input type="checkbox" value="31">31 <input
							...
							value="33">33 <input type="checkbox" value="34">34
						<input type="checkbox" value="35">35 <input
							type="checkbox" value="36">36 <input type="checkbox"
							value="37">37 <input type="checkbox" value="38">38
					...
					<div class="imp secondList">
						<input type="checkbox" value="41">41 <input
							...
							value="43">43 <input type="checkbox" value="44">44
						<input type="checkbox" value="45">45 <input
							type="checkbox" value="46">46 <input type="checkbox"
							value="47">47 <input type="checkbox" value="48">48
					...
					<div class="imp secondList">
						<input type="checkbox" value="51">51 <input
							...
							value="53">53 <input type="checkbox" value="54">54
						<input type="checkbox" value="55">55 <input
							type="checkbox" value="56">56 <input type="checkbox"
							value="57">57 <input type="checkbox" value="58">58
				...
				<div title="分钟">
					...
					<div class="line">
						...
						<input class="numberspinner" style="width: 60px;"
							data-options="min:0,max:59" value="0"> 分钟开始,每 <input
							class="numberspinner" style="width: 60px;"
				...
				<div title="小时">
					...
					<div class="line">
						...
						<input class="numberspinner" style="width: 60px;"
							data-options="min:0,max:23" value="0"> - <input
							class="numberspinner" style="width: 60px;"
					...
					<div class="line">
						...
						<input class="numberspinner" style="width: 60px;"
							data-options="min:0,max:23" value="0"> 小时开始,每 <input
							class="numberspinner" style="width: 60px;"
				...
				<div title="日">
					...
					<div class="line">
						...
						<input class="numberspinner" style="width: 60px;"
							data-options="min:1,max:31" value="1"> - <input
							class="numberspinner" style="width: 60px;"
					...
					<div class="line">
						...
						<input class="numberspinner" style="width: 60px;"
							data-options="min:1,max:31" value="1"> 日开始,每 <input
							class="numberspinner" style="width: 60px;"
				...
				<div title="月">
					...
					<div class="line">
						...
						周期从 <input class="numberspinner" style="width: 60px;"
							data-options="min:1,max:12" value="1"> - <input
							class="numberspinner" style="width: 60px;"
					...
					<div class="line">
						...
						从 <input class="numberspinner" style="width: 60px;"
							data-options="min:1,max:12" value="1"> 日开始,每 <input
							class="numberspinner" style="width: 60px;"
				...
				<div title="周">
					...
					<div class="line">
						...
						周期 从星期<input class="numberspinner" style="width: 60px;"
							data-options="min:1,max:7" value="1"> - <input
							class="numberspinner" style="width: 60px;"
							data-options="min:2,max:7" value="2">
					</div>
					<div class="line">
						<input type="radio" name="week" onclick="weekOfDay(this)">
						第<input class="numberspinner" style="width: 60px;"
							data-options="min:1,max:4" value="1"> 周 的星期<input
							class="numberspinner" style="width: 60px;"
							data-options="min:1,max:7" value="1">
					</div>
					<div class="line">
				...
				<div title="年">
					...
					<div class="line">
						...
						<input class="numberspinner" style="width: 90px;"
							data-options="min:2013,max:3000" value="2013"> - <input
							class="numberspinner" style="width: 90px;"
							data-options="min:2014,max:3000" value="2014">
					</div>
				</div>
			</div>
		</div>
